        ...
        <form action="" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <select name="kategori_barang" id="kategori_barang" class="form-control <?= form_error('kategori_barang') ? 'is-invalid' : null ?>">
                  ...
                  <?= $params = $this->input->post('kategori_barang') ?? $data->id_kategori_barang ;?>
                  <?php foreach($kategori->result() as $kt):?>
                    <option value="<?= $kt->id_kategori_barang ?>" <?= $kt->id_kategori_barang == $params ? 'selected' : null ?> > <?= $kt->nama_kategori?> </option>
                  <?php endforeach;?>
                </select>
            ...
            <div class="form-group">
                ...
                <input type="number" class="form-control <?= form_error('harga') ? 'is-invalid' : null ?>" id="harga" name="harga" placeholder="Masukan Harga Barang (Rp)" value="<?= $this->input->post('harga') ?? $data->harga ?>">
                <span class="text-red"><?= form_error('harga')?></span>
            </div>
            <div class="form-group">
                <label for="deskripsi">Deskripsi Barang :</label>
                <textarea name="deskripsi" id="deskripsi" class="form-control <?= form_error('deskripsi') ? 'is-invalid' : null ?>" placeholder="Masukan Deskripsi Barang"><?= $this->input->post('deskripsi') ?? $data->deskripsi ;?></textarea>
