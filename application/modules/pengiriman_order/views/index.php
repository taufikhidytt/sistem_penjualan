        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item">Data Pengiriman Order</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    ...
    <section class="content">
      ...
      <div class="card">
        <div class="card-header">
          <h3 class="card-title">Data Pengiriman Order</h3>
        ...
        <div class="card-body">
            <table class="table table-bordered table-responsive-lg table-hover table-striped text-center" id="table">
                ...
                <tr>
                    ...
                    <td>
                        <a href="<?= base_url('pengiriman_order/status/'.$dt->id_transaction)?>" class="btn btn-primary btn-sm">
                            <i class="fa fa-highlighter"></i>
                        </a>
                    </td>
                    <td>
                        <a href="<?= base_url('pengiriman_order/print/'.$dt->id_transaction)?>" class="btn btn-success btn-sm" target="blank">
