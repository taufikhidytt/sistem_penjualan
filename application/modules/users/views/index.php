...
<div class="content-wrapper">
  ...
  <section class="content">
    ...
    <div class="card">
      ...
      <div class="card-body">
        <a href="<?= base_url('users/add')?>" class="btn btn-success btn-sm">
        ...
        <table class="table table-bordered table-responsive-lg table-striped text-center" id="table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <?php }?>
                    <td>
                        <a href="<?= base_url('users/update/'.$dt->id_users)?>" class="btn btn-primary btn-sm">
                            <i class="fa fa-pencil-alt"></i>
                        </a>  |
                        <form action="<?= base_url('users/del')?>" method="post" class="d-inline">
