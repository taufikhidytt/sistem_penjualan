                ...
                <div class="col-lg-4 col-sm-12">
                    <div class="form-group">
                        ...
                        <select name="level" id="level" class="form-control <?= form_error('level') ? 'is-invalid' : null ?>">
                            ...
                            <option value="superadmin" <?= set_value('level') == 'superadmin' ? 'selected' : null ?>>Super Admin</option>
                            <option value="admin" <?= set_value('level') == 'admin' ? 'selected' : null ?>>Admin</option>
                            <option value="gudang" <?= set_value('level') == 'gudang' ? 'selected' : null ?>>Gudang</option>
                ...
                <div class="col-lg-4 col-sm-12">
                    <div class="form-group">
                        ...
                        <select name="status" id="status" class="form-control <?= form_error('status') ? 'is-invalid' : null ?>">
                            <option value="">--Select--</option>
                            <option value="active" <?= set_value('status') == 'active' ? 'selected' : null; ?>>Active</option>
                            <option value="inactive" <?= set_value('status') == 'inactive' ? 'selected' : null ?>>Inactive</option>
