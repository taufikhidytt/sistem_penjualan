    ...
    <div class="card">
      ...
      <div class="card-body">
        <form action="" method="post">
          ...
          <div class="row">
            ...
            <div class="col-lg-4 col-sm-12">
              <div class="form-group">
                ...
                <input type="text" name="stok_barang" id="stok_barang" class="form-control <?= form_error('stok_barang') ? 'is-invalid' : null ?>" readonly value="<?= $this->input->post('stok_barang')?>" placeholder="-">
                <span class="text-red"><?= form_error('stok_barang')?></span>
              </div>
            </div>
            <div class="col-lg-4 col-sm-12">
              <div class="form-group">
          ...
          <div class="row">
            <div class="col-lg-6 col-sm-12">
              <div class="form-group">
                ...
                <input type="number" class="form-control <?= form_error('qty') ? 'is-invalid' : null ?>" id="qty" name="qty" placeholder="Masukan Qty Barang" min="1" value="<?= $this->input->post('qty')?>">
          ...
          <a class="btn btn-primary btn-sm float-right" href="<?= base_url('transaction/requestBarang')?>">
