        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item active">Data Stock Out Barang</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    ...
    <section class="content">
      ...
      <div class="card">
        <div class="card-header">
          <h3 class="card-title">Stock Out Barang</h3>
        ...
        <div class="card-body">
            <a href="<?= base_url('stock_out/add')?>" class="btn btn-success btn-sm">
                <i class="fa fa-plus"></i> Stock Out
            </a>
            <br><br>
            <table class="table table-bordered table-responsive-lg table-striped text-center" id="table">
                ...
                <tbody>
                  ...
                  <tr>
                      ...
                      <td><?= $dt->stock;?></td>
                      <td><?= $dt->status;?></td>
                      <td><?= substr($dt->description, 0, 50);?></td>
