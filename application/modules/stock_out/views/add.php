      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="<?= base_url('stock_out')?>">Data Stock Out</a></li>
    ...
    <div class="card">
      <div class="card-header">
        <div class="card-title">
            <a href="<?= base_url('stock_out')?>" class="btn btn-secondary btn-sm">
      ...
      <div class="card-body">
        <form action="" method="post" enctype="multipart/form-data">
            ...
            <div class="row">
              ...
              <div class="col-lg-6 col-sm-12">
                <div class="form-group">
                  <label for="stok">Stok Out :</label>
                  <input type="number" class="form-control <?= form_error('stok') ? 'is-invalid' : null ?>" id="stok" name="stok" placeholder="Masukan Jumlah Stok Out Barang" min="1" value="<?= $this->input->post('stok')?>">
            ...
            <div class="form-group">
              ...
              <textarea name="description" id="description" class="form-control <?= form_error('description') ? 'is-invalid' : null ?>" placeholder="Masukan Description Stock Out" ><?= $this->input->post('description')?></textarea>
