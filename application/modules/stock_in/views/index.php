        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item active">Data Stock In Barang</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    ...
    <section class="content">
      ...
      <div class="card">
        <div class="card-header">
          <h3 class="card-title">Stock In Barang</h3>
        ...
        <div class="card-body">
            <a href="<?= base_url('stock_in/add')?>" class="btn btn-success btn-sm">
