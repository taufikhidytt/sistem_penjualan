...
<div class="content-wrapper">
  ...
  <section class="content">
    ...
    <div class="card">
      ...
      <div class="card-body">
        <a href="<?= base_url('kategori_barang/add') ?>" class="btn btn-success btn-sm">
          ...
          <tbody>
            ...
            foreach ($data->result() as $dt) : ?>
              <tr>
                ...
                <td><?= substr($dt->deskripsi, 0, 50); ?></td>
                <td><?= $dt->nama; ?>[<?= $dt->level ?>]</td>
                <td>
                  <a href="<?= base_url('kategori_barang/update/' . $dt->id_kategori_barang) ?>" class="btn btn-primary btn-sm">
                    <i class="fa fa-pencil-alt"></i>
                  </a> |
                  <form action="<?= base_url('kategori_barang/del') ?>" method="post" class="d-inline">
                    <input type="hidden" name="id" value="<?= $dt->id_kategori_barang ?>">
