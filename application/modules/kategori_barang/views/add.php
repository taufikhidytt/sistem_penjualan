      ...
      <div class="card-body">
        <form action="" method="post" enctype="multipart/form-data">
          <div class="form-group">
            ...
            <input type="text" class="form-control <?= form_error('nama_kategori') ? 'is-invalid' : null ?>" id="nama_kategori" name="nama_kategori" placeholder="Masukan Nama Kategori Barang" value="<?= $this->input->post('nama_kategori') ?>">
            <span class="text-red"><?= form_error('nama_kategori') ?></span>
          </div>
          <div class="form-group">
            <label for="deskripsi">Description Kategori Barang :</label>
            <textarea name="deskripsi" id="deskripsi" class="form-control <?= form_error('deskripsi') ? 'is-invalid' : null ?>" placeholder="Masukan Deskripsi Kategori Barang"><?= $this->input->post('deskripsi'); ?></textarea>
